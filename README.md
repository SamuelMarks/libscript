...
**LibScript** is a modular, zero-dependency shell-script based framework for provisioning, installing, and configuring software toolchains, servers, and applications across Linux, macOS, MS-DOS, and Windows.
