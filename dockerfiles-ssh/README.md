...
## Usage
This document describes the `dockerfiles-ssh` directory within the LibScript ecosystem. This folder contains Dockerfiles and related configuration for setting up SSH servers via Docker.
...
You can override the global setting for specific dependencies by setting their respective `DOCKERFILES_SSH_INSTALL_METHOD` variable. The local override takes highest precedence. 
