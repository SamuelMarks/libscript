# ## Overview
# PowerShell script for setup_generic.ps1 for stack 'openvpn'.
#
# ## Usage
...
<#
.SYNOPSIS
Generic PowerShell setup script for openvpn stack.
...
if (Test-Path $SetupPs1) {
    ...
    if (Test-Path $CmdFile) {
        ...
        Write-Output 'openvpn setup_generic completed.'
    }
}
