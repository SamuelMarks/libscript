# ## Overview
# PowerShell script for setup_generic.ps1 for stack 'nextcloud'.
#
# ## Usage
...
<#
.SYNOPSIS
Generic PowerShell setup script for nextcloud stack.
...
if (Test-Path $SetupPs1) {
    ...
    if (Test-Path $CmdFile) {
        ...
        Write-Output 'nextcloud setup_generic completed.'
    }
}
