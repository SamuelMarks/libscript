# ## Overview
# PowerShell script for setup_generic.ps1 for stack 'magento'.
#
# ## Usage
...
<#
.SYNOPSIS
Generic PowerShell setup script for magento stack.
...
if (Test-Path $SetupPs1) {
    ...
    if (Test-Path $CmdFile) {
        ...
        Write-Output 'magento setup_generic completed.'
    }
}
