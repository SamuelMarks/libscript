# ## Overview
# PowerShell script for setup_generic.ps1 for stack 'prestashop'.
#
# ## Usage
...
<#
.SYNOPSIS
Generic PowerShell setup script for prestashop stack.
...
if (Test-Path $SetupPs1) {
    ...
    if (Test-Path $CmdFile) {
        ...
        Write-Output 'prestashop setup_generic completed.'
    }
}
