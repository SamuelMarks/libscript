# ## Overview
# PowerShell script for setup_generic.ps1 for stack 'jupyterhub'.
#
# ## Usage
...
<#
.SYNOPSIS
Generic PowerShell setup script for jupyterhub stack.
...
if (Test-Path $SetupPs1) {
    ...
    if (Test-Path $CmdFile) {
        ...
        Write-Output 'jupyterhub setup_generic completed.'
    }
}
