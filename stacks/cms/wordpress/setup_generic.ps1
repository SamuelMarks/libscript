# ## Overview
# PowerShell script for setup_generic.ps1 for stack 'wordpress'.
#
# ## Usage
...
<#
.SYNOPSIS
Generic PowerShell setup script for wordpress stack.
...
if (Test-Path $SetupPs1) {
    ...
    if (Test-Path $CmdFile) {
        ...
        Write-Output 'wordpress setup_generic completed.'
    }
}
