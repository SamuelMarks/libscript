...
if ! priv chmod 666 "${WWWROOT}/config.php" ; then
  true
fi
if ! priv chmod -R 777 "${WWWROOT}/store/" "${WWWROOT}/cache/" "${WWWROOT}/files/" "${WWWROOT}/images/avatars/upload/" ; then
  true
fi
