...
**Install / Uninstall:**
```sh
libscript install deno [VERSION] [OPTIONS]
...
*Note: On Unix environments, you can also use `./cli.sh <COMMAND> deno [VERSION] [OPTIONS]`. On Windows, use `libscript.cmd` or `cli.cmd`.*
