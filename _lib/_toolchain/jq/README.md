...
**Install / Uninstall:**
```sh
libscript install jq [VERSION] [OPTIONS]
...
*Note: On Unix environments, you can also use `./cli.sh <COMMAND> jq [VERSION] [OPTIONS]`. On Windows, use `libscript.cmd` or `cli.cmd`.*
