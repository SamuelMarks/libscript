...
This directory contains the installation and configuration scripts for `jq`. It is designed to be executed via the global `libscript.sh` router or directly via `cli.sh`.
