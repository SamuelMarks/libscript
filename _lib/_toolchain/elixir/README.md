...
You can manage the lifecycle of Elixir using the `libscript` CLI. 

**Install / Uninstall / Start / Stop / Package:**

```sh
# Install Elixir
./libscript.sh install elixir [VERSION] [OPTIONS]

# Uninstall Elixir
./libscript.sh uninstall elixir

# Start Elixir (if applicable as a daemon/background process)
./libscript.sh start elixir

# Stop Elixir (if applicable)
