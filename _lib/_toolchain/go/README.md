...
go toolchain vars that can be set

## Overview

This directory contains the installation and configuration scripts for `go`. It is designed to be executed via the global `libscript.sh` router or directly via `cli.sh`.
