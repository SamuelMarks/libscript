...
You can easily install, uninstall, start, stop, or package `go` using LibScript.

**Unix (Linux/macOS):**
```sh
# Install
./libscript.sh install go [VERSION] [OPTIONS]
...
```cmd
:: Install
libscript.cmd install go [VERSION] [OPTIONS]
