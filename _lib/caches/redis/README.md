...
| `REDIS_LISTEN_PORT`                | Port for REDIS to listen on                                                                                                                                           | `6379`                     |                  |
| `REDIS_REMOTE_URL`                 | Remote Redis or Valkey connection string (e.g. 'redis://redis.internal:6379/0'). If set, skips local server installation.                                             | `none`                     |                  |
