...
| `HYPRLAND_VERSION`                 | Specific version of hyprland to install.                                                                  | `latest`                   |                  |
| `HYPRLAND_INSTALL_METHOD`          | How to install HYPRLAND. 'libscript_native' uses isolated version dirs, 'system' uses OS package manager. | `system`                   |                  |
