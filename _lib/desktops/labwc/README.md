...
| `LABWC_VERSION`                    | Specific version of labwc to install.                                                                  | `latest`                   |                  |
| `LABWC_INSTALL_METHOD`             | How to install LABWC. 'libscript_native' uses isolated version dirs, 'system' uses OS package manager. | `system`                   |                  |
