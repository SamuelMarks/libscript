...
| `XFCE4_VERSION`                    | Specific version of xfce4 to install.                                                                  | `latest`                   |                  |
| `XFCE4_INSTALL_METHOD`             | How to install XFCE4. 'libscript_native' uses isolated version dirs, 'system' uses OS package manager. | `system`                   |                  |
