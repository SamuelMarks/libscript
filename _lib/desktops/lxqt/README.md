...
| `LXQT_VERSION`                     | Specific version of lxqt to install.                                                                  | `latest`                   |                  |
| `LXQT_INSTALL_METHOD`              | How to install LXQT. 'libscript_native' uses isolated version dirs, 'system' uses OS package manager. | `system`                   |                  |
