...
| `WESTON_VERSION`                   | Specific version of weston to install.                                                                  | `latest`                   |                  |
| `WESTON_INSTALL_METHOD`            | How to install WESTON. 'libscript_native' uses isolated version dirs, 'system' uses OS package manager. | `system`                   |                  |
