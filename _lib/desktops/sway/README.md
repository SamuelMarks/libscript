...
| `SWAY_VERSION`                     | Specific version of sway to install.                                                                  | `latest`                   |                  |
| `SWAY_INSTALL_METHOD`              | How to install SWAY. 'libscript_native' uses isolated version dirs, 'system' uses OS package manager. | `system`                   |                  |
