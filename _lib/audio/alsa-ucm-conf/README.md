...
```sh
./libscript.sh install alsa-ucm-conf
```
...
| `ALSA_UCM_CONF_VERSION`            | Specific version of alsa-ucm-conf to install.                                                                  | `latest`                   |                  |
| `ALSA_UCM_CONF_INSTALL_METHOD`     | How to install ALSA_UCM_CONF. 'libscript_native' uses isolated version dirs, 'system' uses OS package manager. | `system`                   |                  |
