...
Networked sound server daemon

## Usage

```sh
./libscript.sh install pulseaudio
```
...
| `PULSEAUDIO_VERSION`               | Specific version of pulseaudio to install.                                                                  | `latest`                   |                  |
| `PULSEAUDIO_INSTALL_METHOD`        | How to install PULSEAUDIO. 'libscript_native' uses isolated version dirs, 'system' uses OS package manager. | `system`                   |                  |
