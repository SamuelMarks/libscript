...
| `GDM_VERSION`                      | Specific version of gdm to install.                                                                  | `latest`                   |                  |
| `GDM_INSTALL_METHOD`               | How to install GDM. 'libscript_native' uses isolated version dirs, 'system' uses OS package manager. | `system`                   |                  |
