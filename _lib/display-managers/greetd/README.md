...
Minimal, generic and agnostic login daemon

## Usage

```sh
./libscript.sh install greetd
```
...
| `GREETD_VERSION`                   | Specific version of greetd to install.                                                                  | `latest`                   |                  |
| `GREETD_INSTALL_METHOD`            | How to install GREETD. 'libscript_native' uses isolated version dirs, 'system' uses OS package manager. | `system`                   |                  |
