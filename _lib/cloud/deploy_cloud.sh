...
# @description Automatically handles deploy_cloud for the deploy_cloud.sh (cloud) component.
...
if [ "$#" -lt 4 ]; then
  echo "Usage: ${this_file} <provider> <node_name> <rg_or_vpc_or_project> <region_or_zone> [local_repo_path] [remote_dest]"
