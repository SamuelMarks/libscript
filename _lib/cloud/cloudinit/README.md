...
| `LIBSCRIPT_DEVICE`                 | The device path (e.g. /dev/sdf).                                                   | `none`                     |                  |
| `LIBSCRIPT_MOUNT_POINT`            | The directory where the device should be mounted (e.g. /data).                     | `none`                     |                  |
| `LIBSCRIPT_FS_TYPE`                | The filesystem type (default: ext4).                                               | `none`                     |                  |
