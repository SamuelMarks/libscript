#!/bin/sh
# ## Overview
# Serves as the primary Unix uninstall entry point for the Rust Server component.
# It delegates the core uninstallation logic to the common `uninstall_base.sh` script,
# ensuring standardized cleanup.
# 
# ## Usage
# Execute this script to uninstall the Rust Server component on Unix systems.
