<#
.SYNOPSIS
Provides a generic, cross-platform setup mechanism for the component 'jetstream' stack.

.DESCRIPTION
Execute this script to perform generic initialization steps for jetstream.
#>
