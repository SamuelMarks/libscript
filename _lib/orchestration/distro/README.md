...
| `DISTRO_VERSION`                   | Specific version of distro to install.                                                                  | `latest`                   |                  |
| `DISTRO_INSTALL_METHOD`            | How to install DISTRO. 'libscript_native' uses isolated version dirs, 'system' uses OS package manager. | `system`                   |                  |
