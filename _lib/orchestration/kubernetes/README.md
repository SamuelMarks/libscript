...
| `KUBERNETES_VERSION` | Specific version of Kubernetes/kubectl to install. | `latest` | latest, stable |
| `KUBERNETES_INSTALL_METHOD` | How to install Kubernetes tools. | `libscript_native` |  |
<!-- END_VARS -->
