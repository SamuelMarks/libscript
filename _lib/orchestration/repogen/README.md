...
| `REPOGEN_VERSION`                  | Specific version of repogen to install.                                                                  | `latest`                   |                  |
| `REPOGEN_INSTALL_METHOD`           | How to install REPOGEN. 'libscript_native' uses isolated version dirs, 'system' uses OS package manager. | `system`                   |                  |
