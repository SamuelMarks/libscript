...
This directory contains the scripts to interact with `kubernetes-thw`. It is designed to be executed
...
| `KUBERNETES_THW_VERSION` | Specific version of kubernetes components to install | `latest` |  |
