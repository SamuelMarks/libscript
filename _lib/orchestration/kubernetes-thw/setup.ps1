...
<#
.SYNOPSIS
Orchestrates the setup and installation process for the component 'kubernetes-thw' stack.

.DESCRIPTION
Execute this script to install and configure kubernetes-thw on the local system.
#>
...
if ($Action -eq "download") {
    if ($InstallMethod -eq "libscript_native") {
        Write-Output "Downloading kubernetes-thw to $DownloadDir\kubernetes-thw..."
    }
    exit 0
}
