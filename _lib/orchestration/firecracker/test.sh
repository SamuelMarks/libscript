#!/bin/sh
# ## Overview
# Verifies Firecracker functionality.
#
# ## Usage
# ./test.sh
...
STAMP_FILE="${TARGET_SYSROOT}/var/lib/libscript/stamps/.stamp.firecracker"

if [ -f "$STAMP_FILE" ] || command -v firecracker >/dev/null 2>&1; then
  exit 0
fi
