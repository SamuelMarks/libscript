#!/bin/sh
# ## Overview
# Verifies Cloud-Hypervisor functionality.
#
# ## Usage
# ./test.sh
...
STAMP_FILE="${TARGET_SYSROOT}/var/lib/libscript/stamps/.stamp.cloud-hypervisor"

if [ -f "$STAMP_FILE" ] || command -v cloud-hypervisor >/dev/null 2>&1; then
  exit 0
fi
