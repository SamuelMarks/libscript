<#
.SYNOPSIS
Orchestrates the setup and installation process for the component 'kubernetes-k0s' stack.

.DESCRIPTION
Execute this script to install and configure kubernetes-k0s on the local system.
#>
...
if ($Action -eq "download") {
    if ($InstallMethod -eq "libscript_native") {
        Write-Output "Downloading kubernetes-k0s to $DownloadDir\kubernetes-k0s..."
    }
    exit 0
}
