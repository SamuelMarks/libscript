...
| `CLOUD_VERSION`                    | Specific version of cloud to install.                                                                  | `latest`                   |                  |
| `CLOUD_INSTALL_METHOD`             | How to install CLOUD. 'libscript_native' uses isolated version dirs, 'system' uses OS package manager. | `system`                   |                  |
