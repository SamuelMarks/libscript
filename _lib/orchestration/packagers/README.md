...
| `PACKAGERS_VERSION`                | Specific version of packagers to install.                                                                  | `latest`                   |                  |
| `PACKAGERS_INSTALL_METHOD`         | How to install PACKAGERS. 'libscript_native' uses isolated version dirs, 'system' uses OS package manager. | `system`                   |                  |
