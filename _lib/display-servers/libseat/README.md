...
Universal seat management client library

## Usage

```sh
./libscript.sh install libseat
```
...
| `LIBSEAT_VERSION`                  | Specific version of libseat to install.                                                                  | `latest`                   |                  |
| `LIBSEAT_INSTALL_METHOD`           | How to install LIBSEAT. 'libscript_native' uses isolated version dirs, 'system' uses OS package manager. | `system`                   |                  |
