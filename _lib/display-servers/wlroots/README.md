...
| `WLROOTS_VERSION`                  | Specific version of wlroots to install.                                                                  | `latest`                   |                  |
| `WLROOTS_INSTALL_METHOD`           | How to install WLROOTS. 'libscript_native' uses isolated version dirs, 'system' uses OS package manager. | `system`                   |                  |
