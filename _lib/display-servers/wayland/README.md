...
| `WAYLAND_VERSION`                  | Specific version of wayland to install.                                                                  | `latest`                   |                  |
| `WAYLAND_INSTALL_METHOD`           | How to install WAYLAND. 'libscript_native' uses isolated version dirs, 'system' uses OS package manager. | `system`                   |                  |
