...
Bootstrap component for LibScript systems.

## Usage

```sh
./libscript.sh install bootstrap
```
...
| `BOOTSTRAP_VERSION`                | Specific version of bootstrap to install.                                                                  | `latest`                   |                  |
| `BOOTSTRAP_INSTALL_METHOD`         | How to install BOOTSTRAP. 'libscript_native' uses isolated version dirs, 'system' uses OS package manager. | `system`                   |                  |
