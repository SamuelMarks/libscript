...
:: ## Overview
:: Setup script for maven on Windows.
:: Prepares and configures maven on native Windows environments.
::
:: ## Usage
:: Automatically invoked during libscript maven installation on Windows.
