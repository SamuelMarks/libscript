...
| `GRADLE_INSTALL_METHOD`            | How to install GRADLE. 'libscript_native' uses isolated version dirs, 'system' uses OS package manager, 'mise', 'asdf', 'pkgx', or 'vfox' defers to third-party tools. | `system`                   |                  |
| `GRADLE_VERSION`                   | Specific version of gradle to install. Can be a numeric version or an alias.                                                                                           | `latest`                   |                  |
