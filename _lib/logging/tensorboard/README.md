...
| `TENSORBOARD_VERSION` | Specific version of TensorBoard to install. | `latest` | latest, stable |
| `TENSORBOARD_INSTALL_METHOD` | How to install TensorBoard. | `libscript_native` |  |
<!-- END_VARS -->
