#!/bin/sh
# ## Overview
# Lifecycle script for setup_macos.sh.
#
# ## Usage
# Refer to the internal functions of setup_macos.sh for implementation details.
...
if ! brew ls --versions nginx >/dev/null 2>&1; then
  brew install nginx
fi
