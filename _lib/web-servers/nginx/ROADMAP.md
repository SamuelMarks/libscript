...
**Purpose**: This document provides context and technical details for the `nginx` component (part of
`_server`) within the LibScript ecosystem. LibScript is a modular, zero-dependency shell-script
