...
:: ## Overview
:: Setup script for lighttpd on Windows.
:: Prepares and configures lighttpd on native Windows environments.
::
:: ## Usage
:: Automatically invoked during libscript lighttpd installation on Windows.
