...
Khronos Vulkan ICD loader and headers

## Usage

```sh
./libscript.sh install vulkan-loader
```
...
| `VULKAN_LOADER_VERSION`            | Specific version of vulkan-loader to install.                                                                  | `latest`                   |                  |
| `VULKAN_LOADER_INSTALL_METHOD`     | How to install VULKAN_LOADER. 'libscript_native' uses isolated version dirs, 'system' uses OS package manager. | `system`                   |                  |
