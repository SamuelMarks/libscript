...
Video Acceleration API library

## Usage

```sh
./libscript.sh install libva
```
...
| `LIBVA_VERSION`                    | Specific version of libva to install.                                                                  | `latest`                   |                  |
| `LIBVA_INSTALL_METHOD`             | How to install LIBVA. 'libscript_native' uses isolated version dirs, 'system' uses OS package manager. | `system`                   |                  |
