...
| `LIBVDPAU_VERSION`                 | Specific version of libvdpau to install.                                                                  | `latest`                   |                  |
| `LIBVDPAU_INSTALL_METHOD`          | How to install LIBVDPAU. 'libscript_native' uses isolated version dirs, 'system' uses OS package manager. | `system`                   |                  |
