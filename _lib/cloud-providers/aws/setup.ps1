...
<#
.SYNOPSIS
Orchestrates the setup and installation process for the component 'aws' stack.

.DESCRIPTION
Execute this script to install and configure aws on the local system.
#>
...
if ($Action -eq "download") {
    if ($InstallMethod -eq "libscript_native") {
        Write-Output "Downloading aws to $DownloadDir\aws..."
    }
    exit 0
}
