# gke-tpu-cluster Component

## Overview

This component manages the installation and execution of `gke-tpu-cluster` within the libscript
ecosystem.
...
| `GKE_CLUSTER_VERSION`              | Specific version of GKE to install or use for the cluster.                         | `latest`                   | latest, stable   |
| `GKE_CLUSTER_INSTALL_METHOD`       | How to install GKE Cluster tools.                                                  | `libscript_native`         |                  |
