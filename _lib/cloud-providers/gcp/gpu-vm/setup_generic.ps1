<#
.SYNOPSIS
Provides a generic, cross-platform setup mechanism for the component 'gpu-vm' stack.

.DESCRIPTION
Execute this script to perform generic initialization steps for gpu-vm.
#>
