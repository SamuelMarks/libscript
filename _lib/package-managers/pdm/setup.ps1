<#
.SYNOPSIS
Orchestrates the setup and installation process for the component 'pdm' stack.

.DESCRIPTION
Execute this script to install and configure pdm on the local system.
#>
...
if ($Action -eq "download") {
    if ($InstallMethod -eq "libscript_native") {
        Write-Output "Downloading pdm to $DownloadDir\pdm..."
    }
    exit 0
}
