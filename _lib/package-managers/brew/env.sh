#!/bin/sh
# ## Overview
# Environment variable initialization script for the brew component.
...
BREW_VERSION="${BREW_VERSION:-latest}"
export PATH="${LIBSCRIPT_HOME:-$HOME/.libscript}/brew/${BREW_VERSION}/bin:${PATH}"
