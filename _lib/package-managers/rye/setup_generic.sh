#!/bin/sh
# ## Overview
# Generic setup script for the rye component.
...
if ! command -v rye >/dev/null 2>&1; then
  ...
  _tmp_script="/tmp/rye-install.sh"
  libscript_download "https://rye.astral.sh/get" "$_tmp_script"
  RYE_INSTALL_OPTION="--yes" bash "$_tmp_script"
  rm -f "$_tmp_script"
