#!/bin/sh
# ## Overview
# Environment variable initialization script for the dnf component.
...
DNF_VERSION="${DNF_VERSION:-latest}"
export PATH="${LIBSCRIPT_HOME:-$HOME/.libscript}/dnf/${DNF_VERSION}/bin:${PATH}"
