...
| `HATCH_INSTALL_METHOD`             | How to install HATCH. 'libscript_native' uses isolated version dirs, 'system' uses OS package manager, 'mise', 'asdf', 'pkgx', or 'vfox' defers to third-party tools. | `libscript_native`         |                  |
| `HATCH_VERSION`                    | Specific version of hatch to install.                                                                                                                                 | `latest`                   |                  |
