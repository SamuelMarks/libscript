#!/bin/sh
# ## Overview
# Environment variable initialization script for the component.
...
ANSIBLE_GALAXY_VERSION="${ANSIBLE_GALAXY_VERSION:-latest}"
export PATH="${LIBSCRIPT_HOME:-$HOME/.libscript}/ansible-galaxy/${ANSIBLE_GALAXY_VERSION}/bin:${PATH}"
