...
<#
.SYNOPSIS
Orchestrates the setup and installation process for the component 'msys2' stack.

.DESCRIPTION
Execute this script to install and configure msys2 on the local system.
#>
...
if ($Action -eq "download") {
    if ($InstallMethod -eq "libscript_native") {
        Write-Output "Downloading msys2 to $DownloadDir\msys2..."
    }
    exit 0
}
