<#
.SYNOPSIS
Orchestrates the setup and installation process for the component 'awscli' stack.

.DESCRIPTION
Execute this script to install and configure awscli on the local system.
#>
...
if ($Action -eq "download") {
    if ($InstallMethod -eq "libscript_native") {
        Write-Output "Downloading awscli to $DownloadDir\awscli..."
    }
    exit 0
}
