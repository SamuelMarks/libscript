...
Package organizer with LD_PRELOAD logging for LFS

## Usage

```sh
./libscript.sh install porg
```
...
| `PORG_VERSION`                     | Specific version of porg to install.                                                                  | `latest`                   |                  |
| `PORG_INSTALL_METHOD`              | How to install PORG. 'libscript_native' uses isolated version dirs, 'system' uses OS package manager. | `system`                   |                  |
