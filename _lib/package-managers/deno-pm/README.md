...
| `DENO_PM_INSTALL_METHOD`           | How to install DENO_PM. 'libscript_native' uses isolated version dirs, 'system' uses OS package manager, 'mise', 'asdf', 'pkgx', or 'vfox' defers to third-party tools. | `libscript_native`         |                  |
| `DENO_PM_INSTALL`                  | Path to the directory where Deno should be installed. Defaults to ~/.deno.                                                                                              | `none`                     |                  |
| `DENO_PM_VERSION`                  | Specific version of deno to install.                                                                                                                                    | `latest`                   |                  |
