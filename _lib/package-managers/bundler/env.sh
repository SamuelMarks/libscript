#!/bin/sh
# ## Overview
# Environment variable initialization script for the bundler component.
...
BUNDLER_VERSION="${BUNDLER_VERSION:-latest}"
export PATH="${LIBSCRIPT_HOME:-$HOME/.libscript}/bundler/${BUNDLER_VERSION}/bin:${PATH}"
