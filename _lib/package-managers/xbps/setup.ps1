...
<#
.SYNOPSIS
Orchestrates the setup and installation process for the component 'xbps' stack.

.DESCRIPTION
Execute this script to install and configure xbps on the local system.
#>
...
if ($Action -eq "download") {
    if ($InstallMethod -eq "libscript_native") {
        Write-Output "Downloading xbps to $DownloadDir\xbps..."
    }
    exit 0
}
