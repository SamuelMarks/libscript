...
| `CARGO_BINSTALL_INSTALL_METHOD`    | How to install CARGO_BINSTALL. 'libscript_native' uses isolated version dirs, 'system' uses OS package manager, 'mise', 'asdf', 'pkgx', or 'vfox' defers to third-party tools. | `libscript_native`         |                  |
| `CARGO_BINSTALL_VERSION`           | Specific version of cargo-binstall to install.                                                                                                                                 | `latest`                   |                  |
