#!/bin/sh
# ## Overview
# Environment variable initialization script for the aqua component.
...
AQUA_VERSION="${AQUA_VERSION:-latest}"
export PATH="${LIBSCRIPT_HOME:-$HOME/.libscript}/aqua/${AQUA_VERSION}/bin:${PATH}"
