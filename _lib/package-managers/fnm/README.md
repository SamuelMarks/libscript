...
| `FNM_INSTALL_METHOD`               | How to install FNM. 'libscript_native' uses isolated version dirs, 'system' uses OS package manager, 'mise', 'asdf', 'pkgx', or 'vfox' defers to third-party tools. | `libscript_native`         |                  |
| `FNM_DIR`                          | Installation directory for fnm.                                                                                                                                     | `none`                     |                  |
| `FNM_VERSION`                      | Specific version of fnm to install.                                                                                                                                 | `latest`                   |                  |
