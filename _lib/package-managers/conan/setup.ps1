<#
.SYNOPSIS
Orchestrates the setup and installation process for the component 'conan' stack.

.DESCRIPTION
Execute this script to install and configure conan on the local system.
#>
...
if ($Action -eq "download") {
    if ($InstallMethod -eq "libscript_native") {
        Write-Output "Downloading conan to $DownloadDir\conan..."
    }
    exit 0
}
