...
<#
.SYNOPSIS
Orchestrates the setup and installation process for the component 'emerge' stack.

.DESCRIPTION
Execute this script to install and configure emerge on the local system.
#>
...
if ($Action -eq "download") {
    if ($InstallMethod -eq "libscript_native") {
        Write-Output "Downloading emerge to $DownloadDir\emerge..."
    }
    exit 0
}
