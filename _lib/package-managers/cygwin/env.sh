#!/bin/sh
# ## Overview
# Environment variable initialization script for the cygwin component.
...
CYGWIN_VERSION="${CYGWIN_VERSION:-latest}"
export PATH="${LIBSCRIPT_HOME:-$HOME/.libscript}/cygwin/${CYGWIN_VERSION}/bin:${PATH}"
