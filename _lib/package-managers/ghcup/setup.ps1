...
<#
.SYNOPSIS
Orchestrates the setup and installation process for the component 'ghcup' stack.

.DESCRIPTION
Execute this script to install and configure ghcup on the local system.
#>
...
if ($Action -eq "download") {
    if ($InstallMethod -eq "libscript_native") {
        Write-Output "Downloading ghcup to $DownloadDir\ghcup..."
    }
    exit 0
}
