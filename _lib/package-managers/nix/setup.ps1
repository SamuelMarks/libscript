<#
.SYNOPSIS
Orchestrates the setup and installation process for the component 'nix' stack.

.DESCRIPTION
Execute this script to install and configure nix on the local system.
#>
...
if ($Action -eq "download") {
    if ($InstallMethod -eq "libscript_native") {
        Write-Output "Downloading nix to $DownloadDir\nix..."
    }
    exit 0
}
