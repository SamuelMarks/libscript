...
<#
.SYNOPSIS
Orchestrates the setup and installation process for the component 'asdf' stack.

.DESCRIPTION
Execute this script to install and configure asdf on the local system.
#>
...
if ($Action -eq "download") {
    if ($InstallMethod -eq "libscript_native") {
        Write-Output "Downloading asdf to $DownloadDir\asdf..."
    }
    exit 0
}
