...
<#
.SYNOPSIS
Orchestrates the setup and installation process for the component 'azure-cli' stack.

.DESCRIPTION
Execute this script to install and configure azure-cli on the local system.
#>
...
if ($Action -eq "download") {
    if ($InstallMethod -eq "libscript_native") {
        Write-Output "Downloading azure-cli to $DownloadDir\azure-cli..."
    }
    exit 0
}
