#!/bin/sh
# ## Overview
# Environment variable initialization script for the apt component.
...
APT_VERSION="${APT_VERSION:-latest}"
export PATH="${LIBSCRIPT_HOME:-$HOME/.libscript}/apt/${APT_VERSION}/bin:${PATH}"
