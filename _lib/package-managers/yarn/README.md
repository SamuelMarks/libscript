...
| `YARN_INSTALL_METHOD`              | How to install YARN. 'libscript_native' uses isolated version dirs, 'system' uses OS package manager, 'mise', 'asdf', 'pkgx', or 'vfox' defers to third-party tools. | `system`                   |                  |
| `YARN_VERSION`                     | Specific version of yarn to install.                                                                                                                                 | `latest`                   |                  |
