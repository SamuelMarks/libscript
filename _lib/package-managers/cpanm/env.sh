#!/bin/sh
# ## Overview
# Environment variable initialization script for the cpanm component.
...
CPANM_VERSION="${CPANM_VERSION:-latest}"
export PATH="${LIBSCRIPT_HOME:-$HOME/.libscript}/cpanm/${CPANM_VERSION}/bin:${PATH}"
