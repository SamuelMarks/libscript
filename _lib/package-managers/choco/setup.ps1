...
<#
.SYNOPSIS
Orchestrates the setup and installation process for the component 'choco' stack.

.DESCRIPTION
Execute this script to install and configure choco on the local system.
#>
...
if ($Action -eq "download") {
    if ($InstallMethod -eq "libscript_native") {
        Write-Output "Downloading choco to $DownloadDir\choco..."
    }
    exit 0
}
