#!/bin/sh
# ## Overview
# Environment variable initialization script for the choco component.
...
CHOCO_VERSION="${CHOCO_VERSION:-latest}"
export PATH="${LIBSCRIPT_HOME:-$HOME/.libscript}/choco/${CHOCO_VERSION}/bin:${PATH}"
