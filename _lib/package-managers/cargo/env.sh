#!/bin/sh
# ## Overview
# Environment variable initialization script for the cargo component.
...
CARGO_VERSION="${CARGO_VERSION:-latest}"
export PATH="${LIBSCRIPT_HOME:-$HOME/.libscript}/cargo/${CARGO_VERSION}/bin:${PATH}"
