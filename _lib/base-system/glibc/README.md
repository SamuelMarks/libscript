...
| `GLIBC_VERSION`                    | Specific version of glibc to install.                                                                  | `latest`                   |                  |
| `GLIBC_INSTALL_METHOD`             | How to install GLIBC. 'libscript_native' uses isolated version dirs, 'system' uses OS package manager. | `system`                   |                  |
