...
Linux kernel module loader and management library

## Usage

```sh
./libscript.sh install kmod
```
...
| `KMOD_VERSION`                     | Specific version of kmod to install.                                                                  | `latest`                   |                  |
| `KMOD_INSTALL_METHOD`              | How to install KMOD. 'libscript_native' uses isolated version dirs, 'system' uses OS package manager. | `system`                   |                  |
