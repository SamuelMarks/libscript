...
User account and password management suite

## Usage

```sh
./libscript.sh install shadow
```
...
| `SHADOW_VERSION`                   | Specific version of shadow to install.                                                                  | `latest`                   |                  |
| `SHADOW_INSTALL_METHOD`            | How to install SHADOW. 'libscript_native' uses isolated version dirs, 'system' uses OS package manager. | `system`                   |                  |
