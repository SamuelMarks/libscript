...
XFS filesystem administration utilities

## Usage

```sh
./libscript.sh install xfsprogs
```
...
| `XFSPROGS_VERSION`                 | Specific version of xfsprogs to install.                                                                  | `latest`                   |                  |
| `XFSPROGS_INSTALL_METHOD`          | How to install XFSPROGS. 'libscript_native' uses isolated version dirs, 'system' uses OS package manager. | `system`                   |                  |
