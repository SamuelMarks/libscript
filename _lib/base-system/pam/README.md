...
| `PAM_VERSION`                      | Specific version of pam to install.                                                                  | `latest`                   |                  |
| `PAM_INSTALL_METHOD`               | How to install PAM. 'libscript_native' uses isolated version dirs, 'system' uses OS package manager. | `system`                   |                  |
