...
Device node manager daemon and library

## Usage

```sh
./libscript.sh install eudev
```
...
| `EUDEV_VERSION`                    | Specific version of eudev to install.                                                                  | `latest`                   |                  |
| `EUDEV_INSTALL_METHOD`             | How to install EUDEV. 'libscript_native' uses isolated version dirs, 'system' uses OS package manager. | `system`                   |                  |
