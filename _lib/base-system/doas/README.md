...
Lightweight OpenBSD privilege escalation utility

## Usage

```sh
./libscript.sh install doas
```
...
| `DOAS_VERSION`                     | Specific version of doas to install.                                                                  | `latest`                   |                  |
| `DOAS_INSTALL_METHOD`              | How to install DOAS. 'libscript_native' uses isolated version dirs, 'system' uses OS package manager. | `system`                   |                  |
