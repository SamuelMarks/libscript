...
Traditional Linux packet filter userland utility

## Usage

```sh
./libscript.sh install iptables
```
...
| `IPTABLES_VERSION`                 | Specific version of iptables to install.                                                                  | `latest`                   |                  |
| `IPTABLES_INSTALL_METHOD`          | How to install IPTABLES. 'libscript_native' uses isolated version dirs, 'system' uses OS package manager. | `system`                   |                  |
