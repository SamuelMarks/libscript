...
Intel Wireless Daemon for Linux

## Usage

```sh
./libscript.sh install iwd
```
...
| `IWD_VERSION`                      | Specific version of iwd to install.                                                                  | `latest`                   |                  |
| `IWD_INSTALL_METHOD`               | How to install IWD. 'libscript_native' uses isolated version dirs, 'system' uses OS package manager. | `system`                   |                  |
