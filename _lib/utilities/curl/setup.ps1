...
<#
.SYNOPSIS
Orchestrates the setup and installation process for the component 'curl' stack.

.DESCRIPTION
Execute this script to install and configure curl on the local system.
#>
...
if ($Action -eq "download") {
    if ($InstallMethod -eq "libscript_native") {
        Write-Output "Downloading curl to $DownloadDir\curl..."
    }
    exit 0
}
