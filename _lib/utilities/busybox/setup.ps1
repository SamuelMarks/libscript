<#
.SYNOPSIS
Orchestrates the setup and installation process for the component 'busybox' stack.

.DESCRIPTION
Execute this script to install and configure busybox on the local system.
#>
...
if ($Action -eq "download") {
    if ($InstallMethod -eq "libscript_native") {
        Write-Output "Downloading busybox to $DownloadDir\busybox..."
    }
    exit 0
}
