...
<#
.SYNOPSIS
Orchestrates the setup and installation process for the component 'aria2' stack.

.DESCRIPTION
Execute this script to install and configure aria2 on the local system.
#>
...
if ($Action -eq "download") {
    if ($InstallMethod -eq "libscript_native") {
        Write-Output "Downloading aria2 to $DownloadDir\aria2..."
    }
    exit 0
}
