...
<#
.SYNOPSIS
Orchestrates the setup and installation process for the component 'wget' stack.

.DESCRIPTION
Execute this script to install and configure wget on the local system.
#>
...
if ($Action -eq "download") {
    if ($InstallMethod -eq "libscript_native") {
        Write-Output "Downloading wget to $DownloadDir\wget..."
    }
    exit 0
}
