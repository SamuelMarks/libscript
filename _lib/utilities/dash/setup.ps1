<#
.SYNOPSIS
Orchestrates the setup and installation process for the component 'dash' stack.

.DESCRIPTION
Execute this script to install and configure dash on the local system.
#>
...
if ($Action -eq "download") {
    if ($InstallMethod -eq "libscript_native") {
        Write-Output "Downloading dash to $DownloadDir\dash..."
    }
    exit 0
}
