...
<#
.SYNOPSIS
Orchestrates the setup and installation process for the component 'powershell' stack.

.DESCRIPTION
Execute this script to install and configure powershell on the local system.
#>
...
if ($Action -eq "download") {
    if ($InstallMethod -eq "libscript_native") {
        Write-Output "Downloading powershell to $DownloadDir\powershell..."
    }
    exit 0
}
