...
<#
.SYNOPSIS
Orchestrates the setup and installation process for the component '7zip' stack.

.DESCRIPTION
Execute this script to install and configure 7zip on the local system.
#>
...
if ($Action -eq "download") {
    if ($InstallMethod -eq "libscript_native") {
        Write-Output "Downloading 7zip to $DownloadDir\7zip..."
    }
    exit 0
}
