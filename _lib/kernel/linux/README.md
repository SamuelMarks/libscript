...
Linux component for LibScript systems.

## Usage

```sh
./libscript.sh install linux
```
...
| `LINUX_VERSION`                    | Specific version of linux to install.                                                                  | `latest`                   |                  |
| `LINUX_INSTALL_METHOD`             | How to install LINUX. 'libscript_native' uses isolated version dirs, 'system' uses OS package manager. | `system`                   |                  |
