...
official system package manager (Omnibus). If you encounter issues, consider using Docker instead.
...
| `GITLAB_INSTALL_METHOD` | How to install GITLAB. 'libscript-native' uses isolated version dirs, 'system' uses OS package manager, 'mise' or 'asdf' defers to third-party tools. | `libscript-native` |  |
