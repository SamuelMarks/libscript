<#
.SYNOPSIS
Orchestrates the setup and installation process for the component 'mongodb' stack.

.DESCRIPTION
Execute this script to install and configure mongodb on the local system.
#>
...
if ($Action -eq "download") {
    if ($InstallMethod -eq "libscript_native") {
        Write-Output "Downloading mongodb to $DownloadDir\mongodb..."
    }
    exit 0
}
