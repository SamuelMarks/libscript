...
**Purpose**: This document describes the `debian12` Vagrant folder and environment within the
...
`DEBIAN12_INSTALL_METHOD` variable. The local override takes highest precedence.
