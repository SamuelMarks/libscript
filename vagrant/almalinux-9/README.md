...
**Purpose**: This document describes the `almalinux-9` Vagrant folder and environment within the
...
- **Install**: `libscript install vagrant/almalinux-9`
- **Start**: `libscript start vagrant/almalinux-9`
- **Stop**: `libscript stop vagrant/almalinux-9`
- **Uninstall**: `libscript uninstall vagrant/almalinux-9`
- **Package**: `libscript package vagrant/almalinux-9`
...
`ALMALINUX_9_INSTALL_METHOD` variable. The local override takes highest precedence.
